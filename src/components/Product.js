...
const Product = () => {
    ...
    const getProductDetails = async () => {
        console.log(params)
        let result = await fetch(`http://3.110.81.106/api/v1/products/get-product-details/${params.id}`, {
            method: "POST"
        })
    ...
    const addToCart = async () => {
        ...
        let result = await fetch('http://3.110.81.106/api/v1/products/addToCart', {
            method: 'POST',
