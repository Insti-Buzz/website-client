    ...
    <div className="product-main-container">
      ...
      <div className="product-product-description">
        ...
        <div className="product-size-input-container">
          <label>
            <input type="radio" name="radios" value="S" id="S" />
            <span>S</span>
          </label>
          <label>
            <input type="radio" name="radios" value="M" id="M" />
            <span>M</span>
          </label>
          <label>
            <input type="radio" name="radios" value="L" id="L" />
            <span>L</span>
          </label>
          <label>
            <input type="radio" name="radios" value="XL" id="XL" />
            <span>XL</span>
          </label>
          <label>
            <input type="radio" name="radios" value="2XL" id="2XL" />
            <span>2XL</span>
          </label>
        </div>
        ...
        <div className="product-product-details product-shipping-policy">
          ...
          <p>Your product will be delivered within 15 days of placing the order.</p>
        </div>
        <hr />
