    ...
    return (
        <div className='shop'>
            ...
            <div className="shop-page-info">
                <div className="shop-page-banner"></div>
            </div>
                ...
                <div className="shop-filter-container">
                    ...
                    <div className="filter-bar">
                        ...
                        <div className="style-filter">
                            ...
                            {/* <div className="hoodies-filter sty-fil">Hoodies
                                <Button filterBy="style" value="hoodies" handleClick={handleButtonClick} active={styleFilter === 'hoodies'} />
                            </div> */}
                        </div>
                    </div>
                </div>
